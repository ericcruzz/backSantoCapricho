...
import com.capricho.santoCapricho.Controller.*;
...
public class TicketController {
	@Autowired
	TicketService comandaSer;
	ComandaPlatilloService comandaPser;
	PlatilloService platSer;
	//Get todos los clientes
	
	@GetMapping("/buscar")
	public ArrayList<Ticket> getClients() {
		return comandaSer.findAll();
	}
	//Get clientes por id
	@GetMapping(path = "/buscar/{id}")
	public Optional<Ticket> findById(@Validated @PathVariable("id") Long id) {
		return this.comandaSer.findById(id);

	}
	//post cliente
	@PostMapping("/insertar")
	public Ticket save(@Validated @RequestBody Ticket client) {
